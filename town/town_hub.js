...
(function (w) {
  ...
  var _renderAccum = 0;         // 控制每秒重繪計時
  var _loopTickAccum = 0;       // 控制每秒邏輯計時
  var _rerenderPending = false; // 立即重繪請求標記

  var _progSwitchEnabled = false; // 是否允許程式自動切頁
  ...
  function renderActive(force) {
    ...
    var currentOwner = _body.getAttribute('data-tab-owner');
